            ...
            <table className="w-full text-left">
              ...
              <tbody>
                {data.map((property, index) => (
                  ...
                  >
                    <td className="p-3 font-medium">{property.propertyId}</td>
                    ...
                    <td className="p-3">${property.purchasePrice.toLocaleString()}</td>
                    <td className="p-3">${property.currentValue.toLocaleString()}</td>

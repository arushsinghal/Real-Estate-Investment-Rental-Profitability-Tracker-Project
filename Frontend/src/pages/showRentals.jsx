            ...
            <table className="w-full text-left">
              ...
              <tbody>
                {data.map((rental, index) => (
                  ...
                  >
                    <td className="p-3">{rental.rentalId}</td>
                    <td className="p-3">{rental.propertyId}</td>
                    <td className="p-3">{rental.tenantName}</td>
                    <td className="p-3">₹{rental.monthlyRent.toLocaleString()}</td>
                    <td className="p-3">{new Date(rental.leaseStart).toLocaleDateString()}</td>
                    <td className="p-3">{new Date(rental.leaseEnd).toLocaleDateString()}</td>
                  </tr>
                ))}
              </tbody>
            </table>
